...
class __TwigTemplate_2d4cf39297ea45e9a8201933dc50181d90e8c048ca8417c187d5ed18852a04b9 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <link rel=\"stylesheet/less\" type=\"text/css\" href=\"";
        // line 7
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("css/login.less"), "html", null, true);
        echo "\" />
";
    ...
    ";
        ...
        <div class=\"flex-row\">
            ...
            <input id=\"username\" class=\"lf--input\" name=\"username\" placeholder=\"E-mail\" type=\"email\">
        </div>
        <div class=\"flex-row\">
            ...
            <input id=\"password\" class=\"lf--input\" name=\"password\" placeholder=\"Senha\" type=\"password\">
        </div>
        <input class=\"lf--submit\" type=\"submit\" value=\"Logar\">
    </form>
";
    ...
    {
        return array (  125 => 14,  119 => 12,  116 => 11,  106 => 10,  94 => 7,  89 => 6,  79 => 5,  60 => 3,  37 => 1,);
    }
...
{% endblock %}
", "login/index.html.twig", "C:\\Users\\MauroNRB\\Desenvolvimento\\PHP\\cliente_tarefa_api\\templates\\login\\index.html.twig");
    }
}
