...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('IMI+PFAQfe', 0, ($this->targetDir.''.'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('v5gpkLTQck', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger()))));
    }
    ...
    {
        return $this->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('x7MVyFFVWx', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger()))));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('aLe1DxIEW8', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger()))));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ZC-s3MsOPq', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger()))));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('BfDfeu4IXt', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger()))));
    }
    ...
    protected function getTwig_TemplateCacheWarmerService()
    {
        ...
        ]))->withContext('twig.template_cache_warmer', $this), new \Symfony\Bundle\TwigBundle\TemplateIterator(($this->services['kernel'] ?? $this->get('kernel', 1)), (\dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'), [(\dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'symfony'.\DIRECTORY_SEPARATOR.'twig-bridge/Resources/views/Form') => NULL], (\dirname(__DIR__, 4).'/templates')));
    }
...
class EntityManager_9a5be93 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
     ...
     */
    private $valueHolder30e39 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializera8276 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties68927 = [
        
    ];

    public function getConnection()
    {
        $this->initializera8276 && ($this->initializera8276->__invoke($valueHolder30e39, $this, 'getConnection', array(), $this->initializera8276) || 1) && $this->valueHolder30e39 = $valueHolder30e39;

        return $this->valueHolder30e39->getConnection();
    }

    public function getMetadataFactory()
    {
        $this->initializera8276 && ($this->initializera8276->__invoke($valueHolder30e39, $this, 'getMetadataFactory', array(), $this->initializera8276) || 1) && $this->valueHolder30e39 = $valueHolder30e39;

        return $this->valueHolder30e39->getMetadataFactory();
    }

    public function getExpressionBuilder()
    {
        $this->initializera8276 && ($this->initializera8276->__invoke($valueHolder30e39, $this, 'getExpressionBuilder', array(), $this->initializera8276) || 1) && $this->valueHolder30e39 = $valueHolder30e39;

        return $this->valueHolder30e39->getExpressionBuilder();
    }

    public function beginTransaction()
    {
        $this->initializera8276 && ($this->initializera8276->__invoke($valueHolder30e39, $this, 'beginTransaction', array(), $this->initializera8276) || 1) && $this->valueHolder30e39 = $valueHolder30e39;

        return $this->valueHolder30e39->beginTransaction();
    }

    public function getCache()
    {
        $this->initializera8276 && ($this->initializera8276->__invoke($valueHolder30e39, $this, 'getCache', array(), $this->initializera8276) || 1) && $this->valueHolder30e39 = $valueHolder30e39;

        return $this->valueHolder30e39->getCache();
    }

    public function transactional($func)
    {
        $this->initializera8276 && ($this->initializera8276->__invoke($valueHolder30e39, $this, 'transactional', array('func' => $func), $this->initializera8276) || 1) && $this->valueHolder30e39 = $valueHolder30e39;

        return $this->valueHolder30e39->transactional($func);
    }

    public function wrapInTransaction(callable $func)
    {
        $this->initializera8276 && ($this->initializera8276->__invoke($valueHolder30e39, $this, 'wrapInTransaction', array('func' => $func), $this->initializera8276) || 1) && $this->valueHolder30e39 = $valueHolder30e39;

        return $this->valueHolder30e39->wrapInTransaction($func);
    }

    public function commit()
    {
        $this->initializera8276 && ($this->initializera8276->__invoke($valueHolder30e39, $this, 'commit', array(), $this->initializera8276) || 1) && $this->valueHolder30e39 = $valueHolder30e39;

        return $this->valueHolder30e39->commit();
    }

    public function rollback()
    {
        $this->initializera8276 && ($this->initializera8276->__invoke($valueHolder30e39, $this, 'rollback', array(), $this->initializera8276) || 1) && $this->valueHolder30e39 = $valueHolder30e39;

        return $this->valueHolder30e39->rollback();
    }

    public function getClassMetadata($className)
    {
        $this->initializera8276 && ($this->initializera8276->__invoke($valueHolder30e39, $this, 'getClassMetadata', array('className' => $className), $this->initializera8276) || 1) && $this->valueHolder30e39 = $valueHolder30e39;

        return $this->valueHolder30e39->getClassMetadata($className);
    }

    public function createQuery($dql = '')
    {
        $this->initializera8276 && ($this->initializera8276->__invoke($valueHolder30e39, $this, 'createQuery', array('dql' => $dql), $this->initializera8276) || 1) && $this->valueHolder30e39 = $valueHolder30e39;

        return $this->valueHolder30e39->createQuery($dql);
    }

    public function createNamedQuery($name)
    {
        $this->initializera8276 && ($this->initializera8276->__invoke($valueHolder30e39, $this, 'createNamedQuery', array('name' => $name), $this->initializera8276) || 1) && $this->valueHolder30e39 = $valueHolder30e39;

        return $this->valueHolder30e39->createNamedQuery($name);
    }

    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializera8276 && ($this->initializera8276->__invoke($valueHolder30e39, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializera8276) || 1) && $this->valueHolder30e39 = $valueHolder30e39;

        return $this->valueHolder30e39->createNativeQuery($sql, $rsm);
    }

    public function createNamedNativeQuery($name)
    {
        $this->initializera8276 && ($this->initializera8276->__invoke($valueHolder30e39, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializera8276) || 1) && $this->valueHolder30e39 = $valueHolder30e39;

        return $this->valueHolder30e39->createNamedNativeQuery($name);
    }

    public function createQueryBuilder()
    {
        $this->initializera8276 && ($this->initializera8276->__invoke($valueHolder30e39, $this, 'createQueryBuilder', array(), $this->initializera8276) || 1) && $this->valueHolder30e39 = $valueHolder30e39;

        return $this->valueHolder30e39->createQueryBuilder();
    }

    public function flush($entity = null)
    {
        $this->initializera8276 && ($this->initializera8276->__invoke($valueHolder30e39, $this, 'flush', array('entity' => $entity), $this->initializera8276) || 1) && $this->valueHolder30e39 = $valueHolder30e39;

        return $this->valueHolder30e39->flush($entity);
    }

    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializera8276 && ($this->initializera8276->__invoke($valueHolder30e39, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializera8276) || 1) && $this->valueHolder30e39 = $valueHolder30e39;

        return $this->valueHolder30e39->find($className, $id, $lockMode, $lockVersion);
    }

    public function getReference($entityName, $id)
    {
        $this->initializera8276 && ($this->initializera8276->__invoke($valueHolder30e39, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializera8276) || 1) && $this->valueHolder30e39 = $valueHolder30e39;

        return $this->valueHolder30e39->getReference($entityName, $id);
    }

    public function getPartialReference($entityName, $identifier)
    {
        $this->initializera8276 && ($this->initializera8276->__invoke($valueHolder30e39, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializera8276) || 1) && $this->valueHolder30e39 = $valueHolder30e39;

        return $this->valueHolder30e39->getPartialReference($entityName, $identifier);
    }

    public function clear($entityName = null)
    {
        $this->initializera8276 && ($this->initializera8276->__invoke($valueHolder30e39, $this, 'clear', array('entityName' => $entityName), $this->initializera8276) || 1) && $this->valueHolder30e39 = $valueHolder30e39;

        return $this->valueHolder30e39->clear($entityName);
    }

    public function close()
    {
        $this->initializera8276 && ($this->initializera8276->__invoke($valueHolder30e39, $this, 'close', array(), $this->initializera8276) || 1) && $this->valueHolder30e39 = $valueHolder30e39;

        return $this->valueHolder30e39->close();
    }

    public function persist($entity)
    {
        $this->initializera8276 && ($this->initializera8276->__invoke($valueHolder30e39, $this, 'persist', array('entity' => $entity), $this->initializera8276) || 1) && $this->valueHolder30e39 = $valueHolder30e39;

        return $this->valueHolder30e39->persist($entity);
    }

    public function remove($entity)
    {
        $this->initializera8276 && ($this->initializera8276->__invoke($valueHolder30e39, $this, 'remove', array('entity' => $entity), $this->initializera8276) || 1) && $this->valueHolder30e39 = $valueHolder30e39;

        return $this->valueHolder30e39->remove($entity);
    }

    public function refresh($entity)
    {
        $this->initializera8276 && ($this->initializera8276->__invoke($valueHolder30e39, $this, 'refresh', array('entity' => $entity), $this->initializera8276) || 1) && $this->valueHolder30e39 = $valueHolder30e39;

        return $this->valueHolder30e39->refresh($entity);
    }

    public function detach($entity)
    {
        $this->initializera8276 && ($this->initializera8276->__invoke($valueHolder30e39, $this, 'detach', array('entity' => $entity), $this->initializera8276) || 1) && $this->valueHolder30e39 = $valueHolder30e39;

        return $this->valueHolder30e39->detach($entity);
    }

    public function merge($entity)
    {
        $this->initializera8276 && ($this->initializera8276->__invoke($valueHolder30e39, $this, 'merge', array('entity' => $entity), $this->initializera8276) || 1) && $this->valueHolder30e39 = $valueHolder30e39;

        return $this->valueHolder30e39->merge($entity);
    }

    public function copy($entity, $deep = false)
    {
        $this->initializera8276 && ($this->initializera8276->__invoke($valueHolder30e39, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializera8276) || 1) && $this->valueHolder30e39 = $valueHolder30e39;

        return $this->valueHolder30e39->copy($entity, $deep);
    }

    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializera8276 && ($this->initializera8276->__invoke($valueHolder30e39, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializera8276) || 1) && $this->valueHolder30e39 = $valueHolder30e39;

        return $this->valueHolder30e39->lock($entity, $lockMode, $lockVersion);
    }

    public function getRepository($entityName)
    {
        $this->initializera8276 && ($this->initializera8276->__invoke($valueHolder30e39, $this, 'getRepository', array('entityName' => $entityName), $this->initializera8276) || 1) && $this->valueHolder30e39 = $valueHolder30e39;

        return $this->valueHolder30e39->getRepository($entityName);
    }

    public function contains($entity)
    {
        $this->initializera8276 && ($this->initializera8276->__invoke($valueHolder30e39, $this, 'contains', array('entity' => $entity), $this->initializera8276) || 1) && $this->valueHolder30e39 = $valueHolder30e39;

        return $this->valueHolder30e39->contains($entity);
    }

    public function getEventManager()
    {
        $this->initializera8276 && ($this->initializera8276->__invoke($valueHolder30e39, $this, 'getEventManager', array(), $this->initializera8276) || 1) && $this->valueHolder30e39 = $valueHolder30e39;

        return $this->valueHolder30e39->getEventManager();
    }

    public function getConfiguration()
    {
        $this->initializera8276 && ($this->initializera8276->__invoke($valueHolder30e39, $this, 'getConfiguration', array(), $this->initializera8276) || 1) && $this->valueHolder30e39 = $valueHolder30e39;

        return $this->valueHolder30e39->getConfiguration();
    }

    public function isOpen()
    {
        $this->initializera8276 && ($this->initializera8276->__invoke($valueHolder30e39, $this, 'isOpen', array(), $this->initializera8276) || 1) && $this->valueHolder30e39 = $valueHolder30e39;

        return $this->valueHolder30e39->isOpen();
    }

    public function getUnitOfWork()
    {
        $this->initializera8276 && ($this->initializera8276->__invoke($valueHolder30e39, $this, 'getUnitOfWork', array(), $this->initializera8276) || 1) && $this->valueHolder30e39 = $valueHolder30e39;

        return $this->valueHolder30e39->getUnitOfWork();
    }

    public function getHydrator($hydrationMode)
    {
        $this->initializera8276 && ($this->initializera8276->__invoke($valueHolder30e39, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializera8276) || 1) && $this->valueHolder30e39 = $valueHolder30e39;

        return $this->valueHolder30e39->getHydrator($hydrationMode);
    }

    public function newHydrator($hydrationMode)
    {
        $this->initializera8276 && ($this->initializera8276->__invoke($valueHolder30e39, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializera8276) || 1) && $this->valueHolder30e39 = $valueHolder30e39;

        return $this->valueHolder30e39->newHydrator($hydrationMode);
    }

    public function getProxyFactory()
    {
        $this->initializera8276 && ($this->initializera8276->__invoke($valueHolder30e39, $this, 'getProxyFactory', array(), $this->initializera8276) || 1) && $this->valueHolder30e39 = $valueHolder30e39;

        return $this->valueHolder30e39->getProxyFactory();
    }

    public function initializeObject($obj)
    {
        $this->initializera8276 && ($this->initializera8276->__invoke($valueHolder30e39, $this, 'initializeObject', array('obj' => $obj), $this->initializera8276) || 1) && $this->valueHolder30e39 = $valueHolder30e39;

        return $this->valueHolder30e39->initializeObject($obj);
    }

    public function getFilters()
    {
        $this->initializera8276 && ($this->initializera8276->__invoke($valueHolder30e39, $this, 'getFilters', array(), $this->initializera8276) || 1) && $this->valueHolder30e39 = $valueHolder30e39;

        return $this->valueHolder30e39->getFilters();
    }

    public function isFiltersStateClean()
    {
        $this->initializera8276 && ($this->initializera8276->__invoke($valueHolder30e39, $this, 'isFiltersStateClean', array(), $this->initializera8276) || 1) && $this->valueHolder30e39 = $valueHolder30e39;

        return $this->valueHolder30e39->isFiltersStateClean();
    }

    public function hasFilters()
    {
        $this->initializera8276 && ($this->initializera8276->__invoke($valueHolder30e39, $this, 'hasFilters', array(), $this->initializera8276) || 1) && $this->valueHolder30e39 = $valueHolder30e39;

        return $this->valueHolder30e39->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializera8276 = $initializer;
    ...
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        ...
        if (! $this->valueHolder30e39) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHolder30e39 = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHolder30e39->__construct($conn, $config, $eventManager);
    }

    public function & __get($name)
    {
        $this->initializera8276 && ($this->initializera8276->__invoke($valueHolder30e39, $this, '__get', ['name' => $name], $this->initializera8276) || 1) && $this->valueHolder30e39 = $valueHolder30e39;

        if (isset(self::$publicProperties68927[$name])) {
            return $this->valueHolder30e39->$name;
        }

        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder30e39;
    ...
    {
        $this->initializera8276 && ($this->initializera8276->__invoke($valueHolder30e39, $this, '__set', array('name' => $name, 'value' => $value), $this->initializera8276) || 1) && $this->valueHolder30e39 = $valueHolder30e39;
    ...
    {
        $this->initializera8276 && ($this->initializera8276->__invoke($valueHolder30e39, $this, '__isset', array('name' => $name), $this->initializera8276) || 1) && $this->valueHolder30e39 = $valueHolder30e39;
    ...
    {
        $this->initializera8276 && ($this->initializera8276->__invoke($valueHolder30e39, $this, '__unset', array('name' => $name), $this->initializera8276) || 1) && $this->valueHolder30e39 = $valueHolder30e39;
    ...
    {
        $this->initializera8276 && ($this->initializera8276->__invoke($valueHolder30e39, $this, '__clone', array(), $this->initializera8276) || 1) && $this->valueHolder30e39 = $valueHolder30e39;

        $this->valueHolder30e39 = clone $this->valueHolder30e39;
    }

    public function __sleep()
    {
        $this->initializera8276 && ($this->initializera8276->__invoke($valueHolder30e39, $this, '__sleep', array(), $this->initializera8276) || 1) && $this->valueHolder30e39 = $valueHolder30e39;

        return array('valueHolder30e39');
    }
    ...
    {
        $this->initializera8276 = $initializer;
    }

    public function getProxyInitializer() : ?\Closure
    {
        return $this->initializera8276;
    }

    public function initializeProxy() : bool
    {
        return $this->initializera8276 && ($this->initializera8276->__invoke($valueHolder30e39, $this, 'initializeProxy', array(), $this->initializera8276) || 1) && $this->valueHolder30e39 = $valueHolder30e39;
    }

    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHolder30e39;
    }

    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder30e39;
    }
